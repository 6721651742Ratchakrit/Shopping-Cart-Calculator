...
public class ShoppingCartManualTest {
    ...
    public static void run() {
        ...
        if (total3 == 65.0) {
         ...
         // Test 4: ส่วนลด BOGO กรณี  2 จ่าย 1
        ...
        // Test 5: ส่วนลด BOGO กรณี  3 จ่าย 2
        ...
        if (total5 == 80.0) {
         ...
         // Test 6: ส่วนลด BOGO กรณี 4 จ่าย 2
         ...
         // Test 7: ส่วนลด BULK มีสินค้าตั้งแต่ 6 ชิ้นขึ้นไปลด 10%
        ...
        // Test 8: ส่วนลด BULK ของน้อยกว่า  6 
        ...
        // Test 9: ส่วนลด BOGO มีของแค่ 1 ชิ้น
